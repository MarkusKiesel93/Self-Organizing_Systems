...
class AntTSP(Ant):
    ...
    def move(self, *args, **kwargs) -> None:
        ...
        if self.nodes_not_visited.size > 1:
            ...
            if proabilities_not_visited.sum() > 0.0:
                ...
                selected_node = np.random.choice(self.nodes_not_visited)
        else:
            selected_node = self.nodes_not_visited[0]
        # update values
